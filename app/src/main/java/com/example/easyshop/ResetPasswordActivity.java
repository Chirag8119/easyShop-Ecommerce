                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                Toast.makeText(ResetPasswordActivity.this, "Security Questions Set Successfull ...", Toast.LENGTH_SHORT).show();
                       ...
                       // String mPhone = snapshot.child("phone").getValue().toString();
                        ...
                        if (snapshot.hasChild("Security Questions")) {
                            ...
                            if (!ans1.equals(answer1)) {
                                Toast.makeText(ResetPasswordActivity.this, "Please check the credentials.", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(ResetPasswordActivity.this, "This phone number doest not exists ...", Toast.LENGTH_SHORT).show();
                    }
                }
